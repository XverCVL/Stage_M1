...
class separator_pool {
    public:
        ...
        unsigned int get_separators_size() const { return separators_size; }
        unsigned int get_partitions_size() const { return partitions_size; }
        unsigned int get_k_separators_size() const { return k_separators_size; }
